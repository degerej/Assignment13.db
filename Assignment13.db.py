...
print('Hi, I hope your having a good day.\n'
      ...
      'You will need to use a menu and then proceed as you please.\n'
      'I hope you enjoy!')
...
def create_connection(path):
    ...
    try:
        ...
        print(f"An error has occurred: {haha}")
...
while option != 3:
    ...
    if menu_choice == 1:
        # term is a temporary value to terminate menu when asked
        term = None
        while term != 5:
            ...
            if int(customers_menu_choice) == 2:
                ...
                print("Remember make sure that your spelling is correct or it won't work!")
            ...
            if int(customers_menu_choice) == 4:
                # Deleting by id
                delete_what = int(input("Keep an eye on your spelling (CASE SENSITIVE)\nSpecify id:\n>>>"))
                delete_customer = f"""
                            DELETE FROM
                              Customers
                            WHERE
    ...
    if menu_choice == 2:
        ...
        while term != 5:
            ...
            if int(books_menu) == 2:
                ...
                change_what = str(input("Keep an eye on your spelling (CASE SENSITIVE)\nType what you want to change:\n>>>"))
                # We need to be specific about a book
            ...
            if int(books_menu) == 4:
                # Deleting by id
                book_id = int(input("Keep an eye on your spelling. (CASE SENSITIVE)\nSpecify id:\n>>>"))
                delete_book = f"""
                            DELETE FROM
                              Books
                            WHERE
    ...
    if menu_choice >= 3:
        option = 3
        print("Have a great day and remember programming is great!")
